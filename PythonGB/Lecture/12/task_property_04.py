'''
● Deleter
Помимо “геттера” и “сеттера” можно создать “делейтер”. Он выполняется при вызове команды del для свойства.
Один из возможных вариантов использования “делейтера” - заменять значение на какое-то по умолчанию или помечать элемент
