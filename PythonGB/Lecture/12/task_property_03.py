'''
● Setter
Python позволяет к “геттеру” добавить “сеттер” — метод контролирующий изменение свойства. Добавим пользователю возраст
и будем контролировать чтобы новый возраст был больше старого. Например мы вручную обновляем данные раз в 5-10 лет.
'''
